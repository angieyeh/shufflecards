...
export function moveCardPositions(deck, cut) {
  if (deck.constructor !== Array)
...
export function removeDup(array) {
...
export function numOfShuffles(array) {
  if (array.constructor !== Array)
    return 'Please provide an array.';

  let greatestComDenom;
...
let orderedDeck = seqDeck(createDeck(1002));
let numShufflesBackOrigPos = moveCardPositions(orderedDeck, 101);
console.log(numShufflesBackOrigPos);
let numShuffles = numOfShuffles(numShufflesBackOrigPos);
